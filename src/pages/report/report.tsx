  ...
  const handleImportCSV = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    Papa.parse(file, {
      ...
      complete: (results:any) => {
        const importedSales: Sale[] = results.data.map((row: any) => ({
          sale_id: parseInt(row['Sale ID']),
        ...
        setSales((prevSales) => [...prevSales, ...importedSales]);
      },
      error: (error:any) => {
    ...
    <Container fluid className="p-0 customFont"style={{fontFamily:'CustomFont'}}>
      ...
      <Row noGutters>
        ...
        <Col md={10} className="p-5 content" style={{ marginTop: 20 }}>
          <h3 className="mb-3">All  Report</h3>
          ...
          >
            <i className="bi bi-download"> Export CSV </i>
          </Button>
