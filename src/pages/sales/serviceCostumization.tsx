...
export const ServiceCustumization: React.FC = () => {
...
//then please save the data to the backend database
  ...
  alert('Customization saved!');
  sessionStorage.removeItem('customization');
  navigate(`/Serviceinvoice/${saleId}`);
    // setShowPopup(true);
  ...
  return (
    <Container fluid className="customization-container font">
